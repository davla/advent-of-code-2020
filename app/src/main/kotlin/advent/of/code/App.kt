...
fun main(args: Array<String>) {
    ...
    val result = when (Pair(args[0], args[1])) {
        ...
        Pair("day12", "puzzle1") -> Day12.puzzle1(lines, puzzleArgs)
        Pair("day12", "puzzle2") -> Day12.puzzle2(lines, puzzleArgs)
        ...
        Pair("day17", "puzzle1") -> Day17.puzzle1(lines, puzzleArgs)
        Pair("day17", "puzzle2") -> Day17.puzzle2(lines, puzzleArgs)
        Pair("day18", "puzzle1") -> Day18.puzzle1(lines, puzzleArgs)
        Pair("day18", "puzzle2") -> Day18.puzzle2(lines, puzzleArgs)
        else -> null
    }
    println(result)
}
